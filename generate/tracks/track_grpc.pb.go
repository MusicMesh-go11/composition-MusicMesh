...
type TrackServiceClient interface {
	...
	GetBuCompositionId(ctx context.Context, in *CompositionID, opts ...grpc.CallOption) (*TrackRes, error)
...
func (c *trackServiceClient) GetBuCompositionId(ctx context.Context, in *CompositionID, opts ...grpc.CallOption) (*TrackRes, error) {
	out := new(TrackRes)
...
type TrackServiceServer interface {
	...
	GetBuCompositionId(context.Context, *CompositionID) (*TrackRes, error)
...
func (UnimplementedTrackServiceServer) GetBuCompositionId(context.Context, *CompositionID) (*TrackRes, error) {
