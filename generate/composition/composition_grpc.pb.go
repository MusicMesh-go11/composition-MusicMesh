...
type CompositionServiceClient interface {
	...
	Get(ctx context.Context, in *FilterRequest, opts ...grpc.CallOption) (*CompositionsRes, error)
	GetByID(ctx context.Context, in *CompositionId, opts ...grpc.CallOption) (*CompositionRes, error)
	GetByUserID(ctx context.Context, in *UserId, opts ...grpc.CallOption) (*CompositionRes, error)
	Update(ctx context.Context, in *Composition, opts ...grpc.CallOption) (*Void, error)
...
func (c *compositionServiceClient) Get(ctx context.Context, in *FilterRequest, opts ...grpc.CallOption) (*CompositionsRes, error) {
	out := new(CompositionsRes)
	err := c.cc.Invoke(ctx, "/composition.CompositionService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *compositionServiceClient) GetByUserID(ctx context.Context, in *UserId, opts ...grpc.CallOption) (*CompositionRes, error) {
	out := new(CompositionRes)
...
func (c *compositionServiceClient) Update(ctx context.Context, in *Composition, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
...
type CompositionServiceServer interface {
	...
	Get(context.Context, *FilterRequest) (*CompositionsRes, error)
	GetByID(context.Context, *CompositionId) (*CompositionRes, error)
	GetByUserID(context.Context, *UserId) (*CompositionRes, error)
	Update(context.Context, *Composition) (*Void, error)
...
func (UnimplementedCompositionServiceServer) Get(context.Context, *FilterRequest) (*CompositionsRes, error) {
...
func (UnimplementedCompositionServiceServer) GetByUserID(context.Context, *UserId) (*CompositionRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByUserID not implemented")
}
func (UnimplementedCompositionServiceServer) Update(context.Context, *Composition) (*Void, error) {
...
func _CompositionService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FilterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CompositionServiceServer).Get(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/composition.CompositionService/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CompositionServiceServer).Get(ctx, req.(*FilterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CompositionService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CompositionServiceServer).Update(ctx, req.(*Composition))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CompositionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Get",
			Handler:    _CompositionService_Get_Handler,
		},
		{
			MethodName: "GetByID",
